...
//        println!("after resize and aggregation");
        let mut out = Ipv4Net::aggregate(&self);
//        for net in out.iter() {
//            println!("{:#?} -> {:#?}", net, net.size());
//        }
//        println!("Records:   {:#?}", out.len());
//        println!("Addresses: {:#?}", out.size());

//        println!("after resize and aggregation v2");
//        out.sort();
//        let mut out = Ipv4Net::aggregate(&out);
//        println!("Records:   {:#?}", out.len());
//        println!("Addresses: {:#?}", out.size());
